...
import com.example.social_media.Adapters.StatusViewHolder;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    static  int y;
    // vars
    private ArrayList<Posts> mediaObjects = new ArrayList<>();
...
//        videoSurfaceView.setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIT);
       // videoSurfaceView.setLayoutParams(new LayoutParams(10, 10));
...
//                        new RecyclerViewItemPositionGetter((LinearLayoutManager) getLayoutManager(), recyclerView);

//                Log.e("ItemPostiongetter", String.valueOf(mItemsPositionGetter));
...
//            targetPosition = mediaObjects.size() - 1;
        ...
        StatusViewHolder holder = (StatusViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        thumbnail = holder.thumbnail;
        progressBar = holder.progress_Bar;
        volumeControl = holder.volume_control;
        ...
        String mediaUrl = mediaObjects.get(targetPosition).getPostUrl();
        boolean isImage=mediaUrl.contains(".jpg");
    ...
    public void setMediaObjects(ArrayList<Posts> mediaObjects){
